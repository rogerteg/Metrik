---
name: sdd
description: "Spec Driven Development (SDD) workflow: spec-first methodology, OpenSpec artifact lifecycle (constitution.md, project-context.md, lessons-learned.md, specs, changes), proposal deltas, quality gates, and session prompts."
...
> **Versão:** 1.0  
> **Compatível com:** Google Antigravity (AGY) · Claude Code · Trae IDE · VS Code + Codex · Cursor · Windsurf · OpenCode · Kilo Code  
...
### 5.2 Protocolo Obrigatório: Modelos de Raciocínio Analítico Pré-Tarefas

> **REGRA MANDATÓRIA (Constitution VI):**  
> Antes de listar qualquer tarefa de implementação, o agente DEVE produzir e registrar a análise utilizando os **Modelos de Raciocínio Analítico**:
> 1. **Primeiros Princípios:** Redução aos requisitos atômicos e invariantes fundamentais.
> 2. **Pré-Mortem & Inversão:** Mapeamento preventivo de como a feature pode falhar (race conditions, edge cases, contratos violados).
> 3. **Validação MECE:** Tarefas mutuamente exclusivas e coletivamente exaustivas (100% dos critérios da spec cobertos).
> 4. **Árvore de Decisão & Poda:** Justificativa da escolha arquitetural e explicitação dos caminhos descartados.
> 5. **Falsificabilidade & TDD:** Condição de falha inicial comprovável e teste determinístico de conclusão.
> 6. **Triangulação Adversarial:** Garantia de conformidade com a Constituição e ausência de alucinação de complexidade.

### 5.3 Estrutura Obrigatória do `tasks.md`

```markdown
# Tarefas — [Nome da Feature]

## Modelos de Raciocínio Analítico Pré-Tarefas (Mandatório)
### 1. Decomposição por Primeiros Princípios
- Invariantes fundamentais: [...]
- Premissas descartadas: [...]
### 2. Análise Pré-Mortem & Inversão
- Modos de falha potenciais: [...]
- Mitigações embutidas: [...]
### 3. Validação MECE
- Mutuamente exclusivas: [...]
- Coletivamente exaustivas: [...]
### 4. Árvore de Decisão & Poda
- Alternativas avaliadas e justificativa de poda: [...]
### 5. Falsificabilidade & TDD
- Teste de falha inicial (Red Bar): [...]
- Critério objetivo de sucesso (Green Bar): [...]
...
### 5.4 Anatomia de uma Boa Tarefa
